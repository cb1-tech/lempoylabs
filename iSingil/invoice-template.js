...
export function bankLines(b){return [b.bankName?b.bankName+(b.bankCode?` (${b.bankCode})`:''):b.nickname,b.branch?b.branch+(b.branchCode?` (${b.branchCode})`:''):'',[b.type,b.number].filter(Boolean).join(' '),b.holder,b.currency?`Currency / 通貨: ${b.currency}`:'',b.swift?`SWIFT/BIC: ${b.swift}`:'',b.iban?`IBAN: ${b.iban}`:'',b.international,b.instructions].filter(Boolean)}
